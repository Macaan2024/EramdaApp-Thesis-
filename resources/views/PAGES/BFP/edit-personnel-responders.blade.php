<x-layout.layout>
    <form class="max-w-3xl mx-auto bg-gray-100 shadow-lg rounded-2xl p-8 space-y-6"
        action="{{ route('bfp.update-responders', $responders->user->id) }}"
        method="POST"
        ...
        <div class="text-center">
            <h2 class="text-lg font-semibold text-gray-800 font-[Poppins]">Edit Responder Information</h2>
            <p class="text-gray-500 text-[12px] font-[Poppins]">Update the responder details</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-2">
                ...
                <input type="email" name="email" value="{{ old('email', $responders->user->email) }}"
            ...
            <div>
                ...
                <input type="text" name="lastname" value="{{ old('lastname', $responders->user->lastname) }}"
            ...
            <div>
                ...
                <input type="text" name="firstname" value="{{ old('firstname', $responders->user->firstname) }}"
                ...
                <div class="flex gap-6">
                    <label class="flex items-center gap-2 text-[12px] font-[Poppins]">
                        <input type="radio" value="m" name="gender"
                            {{ old('gender', $responders->user->gender) === 'm' ? 'checked' : '' }}
                            class="text-blue-600 focus:ring-blue-500">
                        Male
                    </label>
                    <label class="flex items-center gap-2 text-[12px] font-[Poppins]">
                        <input type="radio" value="f" name="gender"
                            {{ old('gender', $responders->user->gender) === 'f' ? 'checked' : '' }}
                            class="text-blue-600 focus:ring-blue-500">
                        Female
                    </label>
                </div>
            ...
            <div>
                ...
                <input type="text" name="position" value="{{ old('position', $responders->user->position) }}"
            ...
            <div>
                ...
                <input type="text" name="contact_number" value="{{ old('contact_number', $responders->user->contact_number) }}"
        ...
        rounded-lg cursor-pointer text-[12px] font-[Poppins]">
                ...
                <div class="mt-3 flex justify-start">
                    <img id="photoPreview"
                        src="{{ $responders->user->photo ? asset('storage/' . $responders->user->photo) : '' }}"
                        alt="Preview"
                        class="{{ $responders->user->photo ? 'block' : 'hidden' }}
