<x-layout.layout>
    ...
    <div class="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <form action="{{ route('admin.update-barangay', $barangays->id) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                @csrf
                @method('PUT')
    ...
    <script>
        // Default coordinates: if your barangay has coords, use them; else fallback to Iligan
        let initialLat = {{ $barangays->latitude ?? 8.228 }};
        let initialLon = {{ $barangays->longitude ?? 124.245 }};
        ...
        // Trigger fetch when user finishes typing
