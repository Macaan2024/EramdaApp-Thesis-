<x-layout.layout>
    <form
        ...
        action="{{ route('update-barangay.admin', $barangays->id) }}"
        method="POST"
        ...
        <h4 class="my-5 text-center font-[Poppins] text-[14px] font-medium">Edit Barangay</h4>
